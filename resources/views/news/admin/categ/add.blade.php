   ...
   <div><hr><p>
    ...
    <form action="{{route('adminSaveCtg')}}" method="post">
        ...
        <td align="left">
          ...
          <input type="text" placeholder="категория 1" name="name" value="{{old('name')}}" maxlength="50" size="30" class="form-control">
        </td>
        ...
        <td align="left">
          ...
          @endif
            ...
            <textarea class="form-control" rows="5" cols="32" type="text" placeholder="Описание категории" name="desc" >{!! old('desc')!!}</textarea>
