...
@section('content')
   ...
   <div><hr><p>
    ...
    <hr>
    <form action="{{ route('resUpd', $reso->id) }}" method="post">
        ...
        @if($errors->has('cname'))
          ...
          @endif
           ...
           <input type="text" placeholder="название" name="cname" value="{{ $reso->cname }}" maxlength="50" size="30" class="form-control">
        ...
        <td align="left">
          ...
          @endif
            ...
            <textarea class="form-control" rows="5" cols="32" type="text" placeholder="Описание " name="cdesc" >{!! $reso->cdesc !!}</textarea>
